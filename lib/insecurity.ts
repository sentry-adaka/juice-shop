...
export const publicKey = fs ? fs.readFileSync('encryptionkeys/jwt.pub', 'utf8') : ''
const privateKey = ''
...
export const hmac = (data: string) => crypto.createHmac('sha256', '').update(data).digest('hex')
...
export const isAuthorized = () => expressJwt(({ }) as any)
